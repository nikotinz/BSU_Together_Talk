...
filters:
  - webr
---
# Creating user-friendly documentation to support software developement {background-image=bg.png background-size="100%"}
</br></br>
...
- Knowledge Dissemination (Sharing findings through presentations, publications, and workshops).

## Goals

- Current developement<span class="parenthetical"> bringing new functionality.</span>
...
<span class="parenthetical">pkgdown</span> logic:</br>
...
## Plotly 
![](CLT.mp4){.absolute left="0" top="50" height="85%" loop="true" autoplay="true"}
...
- We <span class="h">don’t need</span> to install R.
- We <span class="h">don’t need</span> to setup a server.
</div>

<div class="fragment" data-fragment-index="2">
#### Limitations
- Not all packages available <span class="h">yet</span>
